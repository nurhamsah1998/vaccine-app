...
export default function BasicTextFields() {
  ...
  const openNotification = (placement) => {
    notification.success({
      ...
      description: 'Data sudah tersimpan di server pusat. Lihat di tab list untuk melihat data user lebih lengkap.',
      placement,
    });
  };
  ...
  const openNotification2 = (placement) => {
    notification.error({
      ...
      description: 'Tolong masukkan input dengan benar. Tidak memasukan data keinput system tidak akan mengirim data.',
      placement,
    });
  };
  ...
  function nurhamsah(e) {
    ...
    axios
      .post('http://localhost:8080/post', body)
      .then((res) => {
        console.log(res);
        setLoading(false);
